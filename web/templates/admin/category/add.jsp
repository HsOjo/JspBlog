...
<t:override name="title">添加文章分类</t:override>

<t:override name="content">
    <ul id="myTab" class="nav nav-tabs">
        <li><a href="${ctx}/admin/category/index">文章分类列表</a></li>
        <li class="active"><a href="${ctx}/admin/category/add">添加文章分类</a></li>
    </ul>
    <div class="placeholder"></div>
    <form method="post" action="${ctx}/admin/category/add" class="form-horizontal" role="form">
