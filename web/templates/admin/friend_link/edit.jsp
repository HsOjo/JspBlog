...
<t:override name="title">编辑友情链接</t:override>
...
<t:override name="content">
    <ul id="myTab" class="nav nav-tabs">
        ...
        <li class="active"><a href="${ctx}/admin/friend_link/edit">编辑友情链接</a></li>
    </ul>
    <div class="placeholder"></div>
    <form method="post" action="${ctx}/admin/friend_link/edit?id=${friend_link.id}" class="form-horizontal" role="form">
